...
// Wed Nov 22 21:04:01 2023 by ROOT version 5.34/36
// from TTree T/titled by PHOOL
// found on file: /gpfs/mnt/gpfs02/phenix/plhf/plhf1/lbichon/taxi/Run16AuAu200MuonsMBP111/19016/merged/1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxDiMuons = 157;
   const Int_t kMaxVtxSngl = 9;
   const Int_t kMaxVtxOrder = 8;
...
public :
 ...
 //CompactEventPlane *DST_COMPACTEPTREE;
   UInt_t          fUniqueID;
   UInt_t          fBits;
   Int_t           evt_cent;
   Float_t         evt_bbcz;
 ...
 //DiMuonContainer_v13 *DST_DiMuonContainer;
   UInt_t          fUniqueID;
   UInt_t          fBits;
   UInt_t          nDiMuons;
   Int_t           DiMuons_;
 ...
 //VtxOutv7        *DST_VtxOut;
   ...
   UInt_t          fBits;
   Int_t           VtxSngl_;
   UInt_t          VtxSngl_fUniqueID[kMaxVtxSngl];   //[VtxSngl_]
   UInt_t          VtxSngl_fBits[kMaxVtxSngl];   //[VtxSngl_]
   Short_t         VtxSngl_Subsystem[kMaxVtxSngl];   //[VtxSngl_]
   Float_t         VtxSngl_vtx[kMaxVtxSngl][3];   //[VtxSngl_]
   Float_t         VtxSngl_vtxerr[kMaxVtxSngl][3];   //[VtxSngl_]
   string          VtxSngl_VtxName[kMaxVtxSngl];
   Int_t           VtxOrder_;
   Int_t           VtxOrder_first[kMaxVtxOrder];   //[VtxOrder_]
   Int_t           VtxOrder_second[kMaxVtxOrder];   //[VtxOrder_]
   ...
   TBranch        *b_DST_VtxOut_fUniqueID;   //!
   TBranch        *b_DST_VtxOut_fBits;   //!
   TBranch        *b_DST_VtxOut_VtxSngl_;   //!
   TBranch        *b_VtxSngl_fUniqueID;   //!
   TBranch        *b_VtxSngl_fBits;   //!
   TBranch        *b_VtxSngl_Subsystem;   //!
   TBranch        *b_VtxSngl_vtx;   //!
   TBranch        *b_VtxSngl_vtxerr;   //!
   TBranch        *b_VtxSngl_VtxName;   //!
   TBranch        *b_DST_VtxOut_VtxOrder_;   //!
   TBranch        *b_VtxOrder_first;   //!
   TBranch        *b_VtxOrder_second;   //!
...
#ifdef Final1_cxx
Final1::Final1(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/lbichon/taxi/Run16AuAu200MuonsMBP111/19016/merged/1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/gpfs/mnt/gpfs02/phenix/plhf/plhf1/lbichon/taxi/Run16AuAu200MuonsMBP111/19016/merged/1.root");
      }
      f->GetObject("T",tree);
...
Int_t Final1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Final1::LoadTree(Long64_t entry)
{
...
//    fChain->SetBranchAddress("fUniqueID", &fUniqueID, &b_DST_DiMuonContainer_fUniqueID);
//    fChain->SetBranchAddress("fBits", &fBits, &b_DST_DiMuonContainer_fBits);
...
//    fChain->SetBranchAddress("fUniqueID", &fUniqueID, &b_DST_EventHeader_fUniqueID);
//    fChain->SetBranchAddress("fBits", &fBits, &b_DST_EventHeader_fBits);
...
//    fChain->SetBranchAddress("fUniqueID", &fUniqueID, &b_DST_TrigLvl1_fUniqueID);
//    fChain->SetBranchAddress("fBits", &fBits, &b_DST_TrigLvl1_fBits);
...
//    fChain->SetBranchAddress("fUniqueID", &fUniqueID, &b_DST_Sync_fUniqueID);
//    fChain->SetBranchAddress("fBits", &fBits, &b_DST_Sync_fBits);
...
//    fChain->SetBranchAddress("fUniqueID", &fUniqueID, &b_DST_VtxOut_fUniqueID);
//    fChain->SetBranchAddress("fBits", &fBits, &b_DST_VtxOut_fBits);
   fChain->SetBranchAddress("VtxSngl", &VtxSngl_, &b_DST_VtxOut_VtxSngl_);
   fChain->SetBranchAddress("VtxSngl.fUniqueID", VtxSngl_fUniqueID, &b_VtxSngl_fUniqueID);
   fChain->SetBranchAddress("VtxSngl.fBits", VtxSngl_fBits, &b_VtxSngl_fBits);
   fChain->SetBranchAddress("VtxSngl.Subsystem", VtxSngl_Subsystem, &b_VtxSngl_Subsystem);
   fChain->SetBranchAddress("VtxSngl.vtx[3]", VtxSngl_vtx, &b_VtxSngl_vtx);
   fChain->SetBranchAddress("VtxSngl.vtxerr[3]", VtxSngl_vtxerr, &b_VtxSngl_vtxerr);
   fChain->SetBranchAddress("VtxSngl.VtxName", VtxSngl_VtxName, &b_VtxSngl_VtxName);
   fChain->SetBranchAddress("VtxOrder", &VtxOrder_, &b_DST_VtxOut_VtxOrder_);
   fChain->SetBranchAddress("VtxOrder.first", VtxOrder_first, &b_VtxOrder_first);
   fChain->SetBranchAddress("VtxOrder.second", VtxOrder_second, &b_VtxOrder_second);
   Notify();
}

Bool_t Final1::Notify()
{
...
void Final1::Show(Long64_t entry)
{
...
Int_t Final1::Cut(Long64_t entry)
{
